...
public class Constants {
    ...
    public static final String REDIRECT_APPLICANT_ID_EDIT = "redirect:/applicant/{username}/edit";
    public static final String REDIRECT_APPLICANT = "redirect:/applicant";
